...
public class LastEnnemyStrategie implements Strategy
{
	ArrayList<Monster>possibleTarget;
	
	public LastEnnemyStrategie()
	{
	...
	/**
	 * Méthode retournant l'id du monstre à cibler
	...
	public int getIdTarget(ArrayList<Monster> listMonster, int portee,Position positionTower)
	{
		if(possibleTarget.size()>0)
		{
			int curseur=possibleTarget.size()-1;
			return possibleTarget.get(curseur).getId();
		}
		else
		{
			return 0;
